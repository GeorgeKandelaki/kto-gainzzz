	...
	return (
		<main className={styles.exerciseForm}>
			<div className={styles.wrapper}>
				<h1 className={styles.exerciseHeading}>{type === "create" ? "Create an Exercise" : "Update an Exercise"}</h1>
				...
				<form onSubmit={handleSubmit} className={styles.form}>
					...
					<div className={styles.container}>
						<div className={styles.fieldContainer}>
							<label>Reps</label>
							<input value={reps} onChange={(e) => setReps(e.target.value)} type="number" className={styles.inputShort} />
						</div>

						<div className={styles.fieldContainer}>
							<label>Sets</label>
							<input value={sets} onChange={(e) => setSets(e.target.value)} type="number" className={styles.inputShort} />
						</div>

						<div className={styles.fieldContainer}>
							<label>Weight</label>
							<input value={weight} onChange={(e) => setWeight(e.target.value)} type="number" className={styles.inputShort} />
						</div>

						<div className={styles.fieldContainer}>
							<label>Metric</label>
							<select onChange={(e) => setMetric(e.target.value)} className={styles.inputShort} value={metric}>
